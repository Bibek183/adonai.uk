...
<body>
    ...
    <main>
        <section id="welcome">
            ...
            <div class="hero-image" style="margin: 2rem 0; text-align: center;">
                <div style="text-align: center; margin: 20px 0;">
                    ...
                    <p style="font-size: 0.7rem; color: #666; margin-top: 10px;">BB version | <a href="https://newadonai.org">newadonai.org</a></p>
                </div>
            </div>
        </section>
        ...
        <section id="contact">
            ...
            <p><strong>Email:</strong> info@newadonai.org | <strong>Website:</strong> <a href="https://newadonai.org">newadonai.org</a></p>
    ...
    <footer>
        ...
        <p style="margin-top: 0.5rem; font-size: 0.9rem;">Official website: <a href="https://newadonai.org">newadonai.org</a></p>
    </footer>
